  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-5">
        ...
        <div onClick={nextPage} className="bg-slate-50 dark:bg-slate-700 m-2 p-2 rounded-xl text-slate-600 dark:text-slate-300 h-96 w-96 text-center flex items-center justify-center">
